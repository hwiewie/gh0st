...
M263隻支持176*144 352*288 (352*288 24彩的試驗只支持biPlanes = 1)
...
int EnumCodecs(int *fccHandler, char *strName)
{
	...
	if (hIC)
	{
		...
		*fccHandler = icInfo.fccHandler;
		//由於得到的szDescription是UNICODE雙字節字串，所以要轉換為ASCII的
		if (strName != NULL)
